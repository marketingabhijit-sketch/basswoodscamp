...
export default function LeadPopupModal({ isOpen, onClose, selectedEvent, selectedCamp }) {
  ...
  return (
    <div className="fixed inset-0 z-50 flex items-center justify-center p-4 bg-[#14251B]/85 backdrop-blur-md transition-all duration-300">
      
      {/* Modal Box */}
      <div className="relative w-full max-w-lg bg-[#14251B] border border-[#F5EFE6]/20 rounded-3xl p-6 sm:p-8 shadow-2xl transition-all max-h-[90vh] overflow-y-auto text-[#F5EFE6]">
        
        {/* Close Button */}
        <button 
          onClick={onClose}
          className="absolute top-5 right-5 p-2 rounded-full bg-white/10 hover:bg-[#C85A28] hover:text-white text-white transition-colors cursor-pointer"
        >
          <X className="w-5 h-5" />
        </button>
        ...
        {submitted ? (
          <div className="text-center py-8">
            <div className="w-16 h-16 bg-[#C85A28]/20 text-[#C85A28] rounded-full flex items-center justify-center mx-auto mb-4 border border-[#C85A28]">
              <CheckCircle2 className="w-10 h-10" />
            </div>
            <h3 className="text-2xl font-black text-white mb-2">Vibe Confirmed!</h3>
            <p className="text-[#EDE7D9] text-sm mb-6 max-w-xs mx-auto">
            ...
            <button
              ...
              className="btn-terracotta px-6 py-3 rounded-xl text-sm font-extrabold w-full cursor-pointer"
            >
          ...
          <div>
            ...
            <div className="flex items-center gap-3 mb-6">
              <div className="w-12 h-12 rounded-2xl bg-[#1A3023] border border-[#C85A28]/40 p-1 flex items-center justify-center shrink-0">
                <Image src="/emblem.png" alt="Bass Woods" width={40} height={40} className="object-contain" />
              </div>
              <div>
                <span className="text-[10px] uppercase font-black tracking-widest text-[#C85A28] flex items-center gap-1">
            ...
            <form onSubmit={handleSubmit} className="space-y-4">
              <div>
                <label className="text-xs font-bold text-[#EDE7D9] block mb-1">Traveler Name *</label>
                <input 
                  type="text" 
                  required
                  ...
                  className="w-full bg-[#1A3023] border border-[#F5EFE6]/20 focus:border-[#C85A28] rounded-xl px-4 py-2.5 text-sm text-white focus:outline-none transition-colors"
                />
              </div>
              ...
              <div className="grid grid-cols-1 sm:grid-cols-2 gap-3">
                ...
                <div>
                  ...
                  <select 
                    ...
                    className="w-full bg-[#1A3023] border border-[#F5EFE6]/20 focus:border-[#C85A28] rounded-xl px-4 py-2.5 text-sm text-white focus:outline-none transition-colors cursor-pointer"
                  >
              ...
              <button 
                type="submit"
                disabled={loading}
                className="w-full btn-terracotta py-3.5 rounded-xl text-sm font-extrabold flex items-center justify-center gap-2 mt-2 cursor-pointer"
              >
